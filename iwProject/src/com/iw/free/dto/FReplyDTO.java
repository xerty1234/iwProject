...
public class FReplyDTO {
	...
	// 댓글 쓰기 용 생성자
	public FReplyDTO(int no, String content, String writer) {
		this.no = no;
	...
	// 댓글의 화면에 표시할 용 생성자
	public FReplyDTO(int rno, int no, String content, String writer, Date writeDate) {
		this(no, content, writer);
		this.rno = rno;
		this.writeDate = writeDate;
	}

	public FReplyDTO() {} // Spring 프레임워크에서 찾는다.
