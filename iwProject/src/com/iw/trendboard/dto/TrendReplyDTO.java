...
public class TrendReplyDTO {
	...
	// 댓글 쓰기 용 생성자
	public TrendReplyDTO(int no, String content, String writer) {
		this.no = no;
	...
	// 댓글의 화면에 표시할 용 생성자
	public TrendReplyDTO(int rno, int no, String content, String writer, Date writeDate) {
		this(no, content, writer);
		this.rno = rno;
		this.writeDate = writeDate;
	}

	public TrendReplyDTO() {} // Spring 프레임워크에서 찾는다.
