...
public class BoardController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			case "/trendboard/list.do":
				...
				= new PageObject2(DBUtil.getConnection(), "TREND_board",
			...
			case "/trendboard/update.do":
				...
				request.setAttribute("trendboardDTO", service.excute(list2));				// viewService에서
				// jsp 이름을 만들어 내고 밑에서 forward 시킨다.
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			case "/trendboard/update.do":
				// 넘어오는 데이터를 BoardDTO에 담는다.
				TrendBoardDTO boardDTO2 = new TrendBoardDTO(
